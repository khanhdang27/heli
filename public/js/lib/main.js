    ...
    var CalendarApi = /** @class */ (function () {
        ...
        CalendarApi.prototype.addEvent = function (eventInput, sourceInput) {
            ...
            if (sourceInput instanceof EventSourceApi) {
                ...
                if (!sourceApi) {
                    console.warn("Could not find an event source with ID \"" + sourceInput + "\""); // TODO: mail
                    return null;
                }
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                if (!isFinal) {
                    if (initialContext === receivingContext && // TODO: write mail for this
    ...
    */
    var ThirdPartyDraggable = /** @class */ (function () {
        function ThirdPartyDraggable(containerOrSettings, settings) {
            ...
            if (
                // wish we could just mail instanceof EventTarget, but doesn't work in IE11
