                                                    ...
                                                    <div class="p-3">
                                                        ...
                                                        @else
                                                            @if ($detail->exam->type == \Constants::EXAMINATION_QUIZ)
                                                                @if ($detail->question->questionContent()->part ==
                                                                \Constants::QUESTION_PART_1 &&
                                                                !empty($detail->question->questionContent()->picture))
                                                                    <img class="img-thumbnail"
                                                                         src="{{ asset('/file/' . $detail->question->questionContent()->picture->id) }}"
                                                                         alt="" width="500">
                                                                @endif
                                                            @endif
                                                        @endif
                                ...
                                <td>
                                    <div class="d-flex justify-content-between">
                                        @if ($detail->answer_type === \Constants::ANSWER_MC &&
                                            !empty($detail->question->questionContent()->findAnswerById($detail->answer)))
                                            <p class="text-truncate" style="max-width: 200px">
                                            ...
                                            <div class="modal-content h-100">
                                                ...
                                                <div class="modal-body row">
                                                    <div class="col-md-6">
                                                        ...
                                                        @if ($detail->answer_type === \Constants::ANSWER_MC)
                                                            @if(!empty($detail->question->questionContent()->findAnswerById($detail->answer)))
                                                                {{ $detail->question->questionContent()->findAnswerById($detail->answer)->answer }}
                                                            @endif
