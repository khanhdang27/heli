                                ...
                                <div class="row">
                                    <div class="col-sm-8 d-flex align-items-start">
                                        <div class="rounded-circle border border-primary mr-4 bg-user user-avatar"
                                            style="background-image: url('{{                                             style="background-image: url('asset(empty(Auth::user()->avatar) ? 'images/user_default.png' : '/file/' . Auth::user()->avatar->id) }}');">
                                        </div>
                                        <div class="mr-4">
                                    ...
                                    <div class="collapse pl-5 mb-5" id="collapseVisa">
                                        <div class="card border-0">
                                            <div class="text-primary">
                                                ...
                                                <label class="h4" for="card-holder-name">Enter Card
                                                    Number</label>
                                                ...
                                                <p class="h4 mt-2">Your card details would be securely saved for
                                                    faster
                                ...
                                <div class="card-body text-primary p-5">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="product-payment card-body mb-3"
                                                    ...
                                                    <p class="text-center">
                                                        <small>{{ \Constants::COURSE_TYPES[$course->type] }}</small>
                                                    </p>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body p-0">
                                                    ...
                                                    <h3 class="font-weight-bold">
                                                        HK${{ $courses_with_group->getPriceDiscount() }}/
                                    ...
                                    <table width="100%" class="my-5">
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <h4 class="font-weight-bold">
                                                    HK$ {{ $courses_with_group->getPrice() }}
                                                    / @lang('keywords.course-item.section')
                                                </h4>
                                            </td>
                                        </tr>
