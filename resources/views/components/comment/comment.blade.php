<div class="card container p-3">
    ...
    @endif
    {!! Form::open(['url' => URL::route('site.comment.store', ['type' => 'post', 'ref' => 0]), 'enctype' => 'multipart/form-data', 'class' => 'form-inline justify-content-end', 'id' => 'comment_form']) !!}
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-6 col-md-6">
                <div class="form-group">
                    {{ Form::label('detail', 'Image', ['class' => 'sr-only', 'form' => 'comment_form']) }}
                    {{ Form::textarea('detail', old('detail'), ['class' => 'form-control w-100', 'rows' => '1', 'form' => 'comment_form', 'placeholder' => 'Content']) }}
                    @error('detail')
