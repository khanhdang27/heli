...
<nav class="navbar navbar-expand-xl container-fluid sub-header border-secondary">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <form class="{{ $page == 'home' ? "ml-auto" : null }} form-inline my-2 my-lg-0" action="{{ route('site.course.search') }}">
            <div class="search">
                <span class="ic-cart"><img src="{{asset("images/ic/ic_search.svg")}}" width="26"></span>
                <input name="course" class="ip-search" type="text" placeholder="@lang('keywords.footer.searchForCourses')">
            </div>
        </form>
    </div>
</nav>
