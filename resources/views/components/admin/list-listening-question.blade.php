...
<ul class="list-group" id="listQuestionListening_{{ $quiz->set }}">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center list-group-item-info selectable"
        ...
        <div class="w-75 py-5" data-toggle="collapse" data-target="#collapseAnswerListening_{{ $question->id }}"
            aria-expanded="true" aria-controls="collapseAnswerListening_{{ $question->id }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::select('part', Constants::QUESTION_PARTS, $question->questionContent()->part,
    ...
    <div id="collapseAnswerListening_{{ $question->id }}" class="collapse"
        aria-labelledby="headingQuestion_{{ $question->id }}" data-parent="#listQuestionListening_{{ $quiz->set }}">
        <div class="card-body">
            <div class="d-flex">
            ...
            {!! Form::open(['url' => route('admin.quiz.question.listening.assessment.setAnswerTrue', ['quiz' =>
            $quiz->id, 'question' => $question->questionContent()->id]), 'method' => 'PUT']) !!}
            @csrf
