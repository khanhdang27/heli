    ...
    @foreach ($questions as $question)
        @if ($question->questionContent())
            <li class="list-group-item d-flex justify-content-between align-items-center list-group-item-info selectable"
                ...
                <div class="modal fade" id="modalSpeakingAssessmentQuestion{{ $question->id }}" tabindex="0"
                    role="dialog" aria-labelledby="modalSpeakingAssessmentQuestion{{ $question->id }}_Title"
                    aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label"
                                        for="audioSpeakingAssessment_{{ $question->id }}">Choose file</label>
                                </div>
                                <div class="form-group">
            ...
            <div id="collapseAnswerSpeakingAssessment__{{ $question->id }}" class="collapse"
                ...
                <div class="card-body">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modalSpeakingAssessmentAnswer{{ $question->id }}" tabindex="-1"
                        aria-labelledby="modalSpeakingAssessmentAnswer{{ $question->id }}Label" aria-hidden="true">
