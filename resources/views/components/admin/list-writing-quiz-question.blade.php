...
<ul class="list-group" id="listQuestionWriting_{{ $quiz->set }}">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center list-group-item-info selectable"
        ...
        <div class="w-75 py-5" data-toggle="collapse" data-target="#collapseAnswerWritingQuiz_{{ $question->id }}"
            aria-expanded="true" aria-controls="collapseAnswerWritingQuiz_{{ $question->id }}">
        ...
        <div class="modal fade" id="modalWritingQuizQuestion_{{ $question->id }}" tabindex="0" role="dialog"
            aria-labelledby="modalWritingQuizQuestion_{{ $question->id }}_Title" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable  modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['methods' => 'put', 'url' => route('admin.quiz.question.writing.quiz.update',
                        ['quiz' => $quiz->id, 'question' => $question->id]), 'id' =>
                        'formReadingQuestion_{{ $question->id }}', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div id="pickFile_update{{ $quiz->id }}">
                            ...
                            <div id="preview_file_already" class="mb-4">
                                <img src="{{ asset('/file/' . $question->questionContent()->file->id) }}" width=100% />
                            </div>
                            @endif
