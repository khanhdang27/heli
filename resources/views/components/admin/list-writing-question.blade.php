<ul class="list-group" id="listQuestionAssessmentWriting_{{ $quiz->set }}">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center list-group-item-info selectable"
        ...
        <div class="w-75 py-5" data-toggle="collapse" data-target="#collapseAnswerAssessmentWriting_{{ $question->id }}"
            aria-expanded="true" aria-controls="collapseAnswerAssessmentWriting_{{ $question->id }}">
        ...
        <div class="modal fade" id="modalAssessmentWritingQuestion_{{ $question->id }}" tabindex="0" role="dialog"
            aria-labelledby="modalAssessmentWritingQuestion_{{ $question->id }}_Title" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        route('admin.quiz.question.writing.assessment.update', ['quiz' => $quiz->id, 'question' =>
                        $question->id])]) !!}
    ...
    <div id="collapseAnswerAssessmentWriting_{{ $question->id }}" class="collapse"
        ...
        <div class="card-body">
            ...
            {!! Form::open(['url' => route('admin.quiz.question.writing.assessment.setAnswerTrue', ['quiz' => $quiz->id,
            'question' => $question->questionContent()->id]), 'method' => 'PUT']) !!}
