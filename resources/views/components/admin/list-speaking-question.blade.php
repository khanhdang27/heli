<ul class="list-group" id="listQuestionSpeakingExercises_{{ $quiz->set }}">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center list-group-item-info"
        ...
        <div class="modal fade" id="modalSpeakingExercisesQuestion_{{ $question->id }}" tabindex="0" role="dialog"
            aria-labelledby="modalSpeakingExercisesQuestion_{{ $question->id }}_Title" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['methods' => 'put', 'url' => route('admin.quiz.question.speaking.exercises.update', ['quiz' => $quiz->id, 'question' => $question->id]), 'id' => 'formReadingQuestion_{{ $question->id }}']) !!}
                        <div class="form-group">
                            <label for="video_code"> Video </label>
                            {{ Form::text('video_code', old('video_code'), ['class' => 'form-control', 'required', 'readonly']) }}
                        </div>
                        <div class="form-group">
        ...
        <script type="application/javascript">
            $(document).ready(function() {
                ...
                $('#modalSpeakingExercisesQuestion_{{ $question->id }}').on('shown.bs.modal', function() {
