        ...
        <div class="header-footer">
            ...
            <div class="chart">
                ...
                <canvas id="headerChart" class="chart-canvas chartjs-render-monitor"
                    style="display: block; width: 1581px; height: 300px;" width="1581" height="300"></canvas>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <button class="btn btn-outline-info" onclick="window.history.go(-1)">
                                <i class="fe fe-arrow-left"></i>
                            </button>
                        </div>
                        <div class="col">
                            <i class="fas fa-arrow-left btn btn-outline-info" onclick="window.history.go(-1)"></i>
                ...
                <div class="card-body">
                    ...
                    <div class="chart">
                        ...
                        <canvas id="ordersChart" class="chart-canvas chartjs-render-monitor" width="996" height="300"
                            style="display: block; width: 996px; height: 300px;"></canvas>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="chart chart-appended">
                        ...
                        <canvas id="devicesChart" class="chart-canvas chartjs-render-monitor" data-toggle="legend"
                            data-target="#devicesChartLegend" width="461" height="241"
                    ...
                    <div id="devicesChartLegend" class="chart-legend"><span class="chart-legend-item"><i
                                class="chart-legend-indicator" style="background-color: #2C7BE5"></i>Desktop</span><span
                            class="chart-legend-item"><i class="chart-legend-indicator"
                                style="background-color: #A6C5F7"></i>Tablet</span><span class="chart-legend-item"><i
                                class="chart-legend-indicator" style="background-color: #D2DDEC"></i>Mobile</span>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="ml-auto col-auto">
                            ...
                            <div class="chart chart-sparkline">
                                ...
                                <canvas class="chart-canvas chartjs-render-monitor" id="sparklineChart" width="75"
                                    height="35" style="display: block; width: 75px; height: 35px;"></canvas>
                            </div>
