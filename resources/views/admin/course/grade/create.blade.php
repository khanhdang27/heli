        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10 col-xl-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['url' => route('admin.course.grade.store', ['course' => $course->id, 'exam' => $exam]), 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
                        @csrf
                        ...
                        <div class="form-group ">
                            ...
                            {{ Form::number('score', old('score'), ['class' => 'form-control', 'required', 'id' => 'score']) }}
                        </div>
