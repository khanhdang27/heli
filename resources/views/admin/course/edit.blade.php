                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="form-group col-12 col-md-4">
                                    ...
                                    {{ Form::select('type', \Constants::COURSE_TYPES, $course->type, ['class' => 'form-control']) }}
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="level">Level</label>
                                    {{ Form::select('level', \Constants::LEVELS, $course->level, ['class' => 'form-control']) }}
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="type_part">Type Part</label>
                                    {{ Form::select('type_part', \Constants::COURSE_PARTS, $course->type_part, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            <div class="form-group ">
