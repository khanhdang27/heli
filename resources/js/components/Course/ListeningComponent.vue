                    ...
                    <div class="col-lg-8">
                        <div class="h-100">
                            ...
                            <div v-if="typeExam === $getConst('exercise') &&
                                ...
                                <div v-if="checkAnswer[questionIndex] === $getConst('correct')"
                            ...
                            <div v-if="typeExam === $getConst('quiz') && questionListening[questionIndex]">
                                <h3 v-cloak>
                                    {{
                    ...
                    <div class="row justify-content-center align-items-start">
                        <div class="col-lg-6 col-md-10 col-12">
                            <div class="text-left mb-2"
                                 ...
                                 :key="result.question">
                                <div v-for="questionItem in questionListening"
                                    ...
                                    <div v-else>
                                        ...
                                        <h5 class="ml-4" v-for="answerItem in questionItem.listen_assessment_question.answers"
