<template>
    <div class="text-primary">
        ...
        <div v-if="allResults.length === 0">
            <div class="text-center h4 my-3" v-if="typeExam !== $getConst('exercise')">
            ...
            <div class="row container-fluid">
                <div class="col-lg-6 py-4">
                    <div class="px-3 lecture overflow-auto" v-if="startQuiz===true" v-html="passage">
                        {{ passage }}
                    </div>
                </div>
                <div class="col-lg-6 py-4">
        ...
        <div v-else class="mt-5 h-100">
            <div class="text-center">
                ...
                <div>
                    ...
                    <span class="h4" v-if="typeExam===$getConst('quiz')">Number of correct question {{
                            allResults[0].correct_question
                        }}</span>
                    <span class="h4" v-if="typeExam===$getConst('assessment')">Number of wrong question {{
...
export default {
    ...
    methods: {
        ...
        getReadingExerciseQuestions() {
            axios.get(route("site.exam.getReadingExerciseQuestionsClient", this.examId))
                .then((response) => {
                    console.log(response.data)
        ...
        getReadingQuizQuestions() {
            axios.get(route("site.exam.getReadingQuizQuestionsClient", this.examId))
                .then((response) => {
                    console.log(response.data)
                    this.passage=response.data.questions[0].passage.content
                    this.questionReading= response.data.questions[0].question
