        ...
        <div v-if="allResults.length === 0">
            ...
            <div class="row container-fluid m-0">
                <div class="col-lg-6 py-4">
                    <div class="pr-3 lecture overflow-auto"
                        ...
                        <div class="h-100">
                            ...
                            <div v-if="typeExam === $getConst('exercise') &&
                                ...
                                <div v-if="checkAnswer[questionIndex] === $getConst('incorrect')">
                                    ...
                                    <h5 v-for="answer_item in questionReading[questionIndex].reading_question.answers"
                                ...
                                <div class="p-3 bg-success rounded h5 text-white font-weight-bold"
                                     v-if="questionReading[questionIndex] &&
                    ...
                    <div class="row justify-content-center align-items-start">
                        <div class="col-lg-6 col-md-10 col-12">
                            <div class="text-left mb-2"
                                 ...
                                 :key="result.question">
                                <div v-for="questionItem in questionReading"
                                    ...
                                    <div v-else>
                                        ...
                                        <h5 class="ml-4" v-for="answerItem in questionItem.reading_question.answers"
    ...
    methods: {
        ...
        check: function () {
            if (undefined) {
                ...
                for (let i = 0;
                     i < this.questionReading[this.questionIndex].reading_question.answers.length;
                     i++)
                {
                    if (this.questionReading[this.questionIndex].reading_question.answers[i].id ===
                        this.userChoose[this.questionIndex])
                    {
                        if (this.questionReading[this.questionIndex].reading_question.answers[i].is_correct ===
                            this.$root.$getConst("correct"))
                        {
