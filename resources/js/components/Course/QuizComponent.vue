...
<!--            </div>-->
    <div class="h-100">
        <div v-if="typeExercise === 'writing'">
            <writing-component v-bind:questionWriting = "questions" ></writing-component>
        </div>
        <div v-if="typeExercise === 'reading'">
            <reading-component v-bind:questionWriting = "questions"></reading-component>
        </div>
        <div v-if="typeExercise === 'listening'">
            <listening-component v-bind:questionWriting = "questions"></listening-component>
        </div>
        <div v-if="typeExercise === 'speaking'" class="h-100">
            <speaking-component v-bind:questionWriting = "questions"></speaking-component>
        </div>
    </div>
</template>
<script>
