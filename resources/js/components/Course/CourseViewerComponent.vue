        ...
        <div class="row mb-4" id="video-lecture">
            <div class="col-lg-9 bg-white">
                <div class="min-vh-50 h-100 border border-primary">
                    <div v-if="lectureList[lectureIndex] &&
                    ...
                    <ul class="list-group list-group-flush"
                        ...
                        <div class="d-flex">
                            <button class="list-group-item list-group-item-action border-0"
                                ...
                                <div class="d-flex w-100 justify-content-left">
                                    ...
                                    <div v-if="item.model_name == 'Examination'">
                                        ...
                                        <strong v-if="item.index <= lectureOpenTo"
                            ...
                            <div v-if="item.model_name == 'Lecture' && item.file">
                                <a class="btn btn-light text-nowrap font-weight-bold shadow-sm h-100 pt-4"
                    ...
                    <swiper-slide v-for="course in related" :key="course.id">
                        <div class="top-product col-12" v-on:click="goToCourse(course.id)">
                            <div class="content-product py-5 rounded-top-course"
                                 v-bind:style="{ backgroundColor: course.subject.subject_color_background, }">
